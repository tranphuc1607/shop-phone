...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
    <%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <div id="header" style="width :calc(100% - 260px)" class ="px-[15px] left-[260px] bg-[#fff] flex justify-between items-center h-[60px] border-b-2 fixed top-0">
