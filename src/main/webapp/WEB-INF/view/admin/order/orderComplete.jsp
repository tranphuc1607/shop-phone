              ...
              <div id="content" class="flex-1 pt-[60px] px-[20px] w-full ml-[260px]">
                <main>
                    <div class="container mx-auto p-4">
                        <h1 class="text-3xl font-bold text-orange-500 mb-4">Quản lí đơn hàng hoàn thành</h1>
                        <nav class ="text-sm mb-6">
                          <ol class="list-reset flex text-gray-700">
                            <li><a href="/admin/dashboard" class="text-blue-500 hover:underline">Thống kê</a></li>
                            <li><span class="mx-2">/</span></li>
                            <li class="text-gray-500">Đơn hàng hoàn thành</li>
                          </ol>
                        </nav>
                        <div class="mt-8">
                          <div class="mb-4">
                              <h3 class="text-xl font-semibold mb-2 md:mb-0">Đơn hàng hoàn thành</h3>
                          </div>
                              ...
                              <table class="min-w-full bg-white shadow rounded-lg overflow-hidden">
                                  <thead class="bg-gray-100">
                                      <tr>
                                          ...
                                          <th class="py-2 px-4 text-left">Nhà máy</th>
